...
public class Produkt {
    ...
    public static Produkt generateProdukt(int iloscKategorii){
        ...
        produkt.kategoria_producent_id = rand.nextInt(iloscKategorii) + 1;
    ...
    public static String generateNazwa() {
        RandomString randomString = new RandomString(rand.nextInt(26) + 4);
    ...
    public static int generateKategoria(int iloscKategorii){
        return rand.nextInt(iloscKategorii) + 1;
    }
}
